...
export class TimeTravelDebugger {
  ...
  constructor(outputDir: string = './reports/time-travel') {
  ...
  getSnapshot(stepNumber: number): StepSnapshot | undefined {
    return this.snapshots.find(s => s.stepNumber === stepNumber);
  }

  getLastSnapshot(): StepSnapshot | undefined {
...
export function createTimeTravelDebugger(outputDir?: string): TimeTravelDebugger {
