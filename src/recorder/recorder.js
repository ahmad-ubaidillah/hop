...
export class Recorder {
    ...
    recordEvent(type, selector, value, extra) {
        this.events.push({
            type,
            selector,
            value,
...
${steps}`;
    ...
    generateStep(event, usedSelectors) {
