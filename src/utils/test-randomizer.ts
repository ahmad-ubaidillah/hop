...
export class TestRandomizer {
  ...
  shuffleScenarios<T>(scenarios: T[], seed?: number): T[] {
  ...
  shuffleFeatures<T extends { scenarios?: any[] }>(features: T[], seed?: number): T[] {
    if (seed) this.setSeed(seed);
 ...
 */
export function createRandomizer(seed?: number): TestRandomizer {
 ...
 */
export function generateTestData(type: string, options: any = {}): any {
...
function generateFallbackData(type: string, options: any): any {
