...
export class SnapshotTester {
    ...
    getDiff(oldValue, newValue) {
        ...
        if (typeof oldValue !== typeof newValue) {
            ...
            diff.added = newValue.filter((v) => !oldValue.includes(v));
            diff.removed = oldValue.filter((v) => !newValue.includes(v));
        }
 ...
 */
export function createSnapshotTester(options) {
